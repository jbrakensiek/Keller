       ...
       integer m(8,-3:3)
       integer cube(0:6,0:6,0:6)

*      'file' is the output of theorem4a.f + Brakensiek's covers
       open(unit=7,file='4cov')
