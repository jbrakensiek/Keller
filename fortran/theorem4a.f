...
*      The output of the executable goes into 'file'
       ...
       integer vect(343,3),adj(343,343),v(343)
...
*      print*,coord1(i1),coord2(i1),coord3(i1)
       ...
       if(v(i1)+v(i2).eq.64) then
       if(i1.eq.229.or.i2.eq.229) then
       icount=icount+1 
       print*,"2"
       print*," "
       print*,i1
...
*      print*,coord1(i2),coord2(i2),coord3(i2)
       ...
       if(v(i1)+v(i2)+v(i3).eq.64) then
       if(i1.eq.229.or.i2.eq.229.or.i3.eq.229) then
       icount=icount+1 
       print*,"3"
       print*," "
       print*,i1
...
*      print*,coord1(i3),coord2(i3),coord3(i3)
       ...
       if(v(i1)+v(i2)+v(i3)+v(i4).eq.64) then
       if(i1.eq.229.or.i2.eq.229.or.i3.eq.229.or.i4.eq.229) then
       icount=icount+1 
       print*,"4"
       print*," "
       print*,i1
...
*      print*,coord1(i4),coord2(i4),coord3(i4)
       ...
       if(v(i1)+v(i2)+v(i3)+v(i4)+v(i5).eq.64) then
       if(i1.eq.229.or.i2.eq.229.or.i3.eq.229.or.i4.eq.229
     c .or.i5.eq.229) then
       icount=icount+1 
       print*,"5"
       print*," "
...
*      print*,coord1(i5),coord2(i5),coord3(i5)
       ...
       if(v(i1)+v(i2)+v(i3)+v(i4)+v(i5)+v(i6).eq.64) then
       if(i1.eq.229.or.i2.eq.229.or.i3.eq.229.or.i4.eq.229
     c .or.i5.eq.229.or.i6.eq.229) then
       icount=icount+1 
       print*,"6"
       print*," "
       print*,i1
...
*      print*,coord1(i6),coord2(i6),coord3(i6)
       ...
       if(v(i1)+v(i2)+v(i3)+v(i4)+v(i5)+v(i6)+v(i7).eq.64) then
       if(i1.eq.229.or.i2.eq.229.or.i3.eq.229.or.i4.eq.229
     c .or.i5.eq.229.or.i6.eq.229.or.i7.eq.229) then
       icount=icount+1 
       print*,"7"
       print*," "
       print*,i1
...
*      print*,coord1(i7),coord2(i7),coord3(i7)
     ...
     c +v(i8).eq.64) then
       if(i1.eq.229.or.i2.eq.229.or.i3.eq.229.or.i4.eq.229
     c .or.i5.eq.229.or.i6.eq.229.or.i7.eq.229.or.i8.eq.229) then
       icount=icount+1 
       print*,"8"
       print*," "
       print*,i1
