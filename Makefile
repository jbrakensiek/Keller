...
cnfgen6: six/cnfgen6.c
	gcc -O2 -Wall six/cnfgen6.c -ocnfgen6

cubecover6: six/cubecover6.c
	gcc -O2 -Wall six/cubecover6.c -ocubecover6
...
table2tex6: six/table2tex6.c cubecover6
	gcc -O2 -Wall six/table2tex6.c -otable2tex6
...
symbreak6: six/symbreak6.c
	gcc -O2 -Wall six/symbreak6.c -osymbreak6
